...
void init_data(const py::module& hgui, const py::module& kernel)
{
	...
	py::class_<image, std::shared_ptr<image>>(hgui, "Image",
			...
			.def(py::init<const std::string&>(), "imagePath"_a,
			...
			.def("save_image", &image::save_image, "filePath"_a,
	...
	py::class_<gif, std::shared_ptr<gif>>(hgui, "GIF",
			...
			.def(py::init<const std::string&>(), "gifPath"_a,
			...
			.def("get_frame", &gif::get_frame, "frameNumber"_a,
				"Retrieves a specific frame of the GIF, including the image and delay.")
			.def("set_delay", py::overload_cast<const std::vector<hgui::kernel::GIFData::delay>&>(&gif::set_delay), "delaysList"_a,
				"Sets the delay for a specific frame in the GIF.")
			.def("set_delay", py::overload_cast<const hgui::kernel::GIFData::delay&, unsigned int>(&gif::set_delay), "delay"_a, "frameNumber"_a,
	...
	py::class_<font, std::shared_ptr<font>>(hgui, "Font",
			...
			.def(py::init<const std::string&>(), "fontPath"_a,
