...
const std::shared_ptr<hgui::kernel::Canvas>& hgui::CanvasManager::create(const std::string& canvasID, const std::shared_ptr<kernel::Shader>& shader, const size& size, const point& position, const color& color)
{
