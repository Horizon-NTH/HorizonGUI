...
hgui::kernel::Button::Button(const std::function<void()>& function, const std::shared_ptr<Shader>& shader, const size& size,
                             const point& position, const std::shared_ptr<Label>& text, const color& color, const float angularRotation,
                             const float cornerAngularRadius,
                             const std::shared_ptr<Texture>& texture) : Widget(shader, size, position, color),
                                                                        m_state(state::NORMAL),
                                                                        m_function(function),
                                                                        m_text(text),
                                                                        m_cornerAngularRadius(cornerAngularRadius),
