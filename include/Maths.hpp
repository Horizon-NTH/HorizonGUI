...
namespace hgui
{
	namespace kernel
	{
		...
		public:
			...
			explicit(false) GLSLvec2(const Vector<T, 2>& vector) noexcept;
			explicit(false) GLSLvec2(const glm::vec<2, T>& vector) noexcept;
			...
			template<typename U>
			explicit(false) GLSLvec2(const glm::vec<2, U>& vector) noexcept;
		...
		public:
			...
			explicit(false) GLSLvec3(const Vector<T, 3>& vector) noexcept;
			explicit(false) GLSLvec3(const glm::vec<2, T>& vector, T z = {}) noexcept;
			explicit(false) GLSLvec3(const glm::vec<3, T>& vector) noexcept;
			...
			template<typename U, typename V>
			explicit(false) GLSLvec3(const glm::vec<2, U>& vector, V z = {}) noexcept;
			template<typename U>
			explicit(false) GLSLvec3(const glm::vec<3, U>& vector) noexcept;
		...
		public:
			...
			explicit(false) GLSLvec4(const Vector<T, 4>& vector) noexcept;
			explicit(false) GLSLvec4(const glm::vec<2, T>& vector, T z = {}, T w = {}) noexcept;
			explicit(false) GLSLvec4(const glm::vec<3, T>& vector, T w = {}) noexcept;
			explicit(false) GLSLvec4(const glm::vec<4, T>& vector) noexcept;
			...
			template<typename U>
			explicit(false) GLSLvec4(const glm::vec<4, U>& vector) noexcept;
		...
		public:
			...
			explicit(false) Color(const Vector<T, 3>& color) noexcept;
			explicit(false) Color(const Vector<T, 4>& color) noexcept;
...
template<typename T>
hgui::kernel::GLSLvec3<T>::GLSLvec3(const glm::vec<2, T>& vector, T z) noexcept :
...
template<typename T>
hgui::kernel::GLSLvec3<T>::GLSLvec3(const glm::vec<3, T>& vector) noexcept:
	Vector<T, 3>({vector.x, vector.y, vector.z}),
	x((*this)[0]),
	y((*this)[1]),
	z((*this)[2])
...
template<typename T>
hgui::kernel::GLSLvec4<T>::GLSLvec4(const glm::vec<2, T>& vector, T z, T w) noexcept :
	Vector<T, 4>({
...
template<typename T>
hgui::kernel::GLSLvec4<T>::GLSLvec4(const glm::vec<3, T>& vector, T w) noexcept :
	Vector<T, 4>({
...
template<typename T>
hgui::kernel::GLSLvec4<T>::GLSLvec4(const glm::vec<4, T>& vector) noexcept :
	Vector<T, 4>({
