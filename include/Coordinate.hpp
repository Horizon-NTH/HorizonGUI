...
namespace hgui::kernel
{
	...
	public:
		...
		Coordinate& undo_responsiveness() noexcept;
	...
	public:
		...
		explicit(false) Point(const Coordinate<T>& point) noexcept;
		explicit(false) Point(Coordinate<T>&& point) noexcept;
	...
	public:
		...
		explicit(false) Size(const Coordinate<T>& size) noexcept;
		explicit(false) Size(Coordinate<T>&& size) noexcept;
...
{
	operator=(coords.operator Coordinate());
	return *this;
}
...
{
	operator=(std::move(coords.operator Coordinate()));
	return *this;
}
...
template<typename T>
hgui::kernel::Coordinate<T>& hgui::kernel::Coordinate<T>::undo_responsiveness() noexcept
{
...
{
	operator=(coords.operator Point());
	return *this;
}
...
{
	operator=(std::move(coords.operator Point()));
	return *this;
}
...
{
	operator=(std::move(size.operator Size()));
	return *this;
}
