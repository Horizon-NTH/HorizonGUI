...
namespace hgui
{
	namespace kernel
	{
		...
		public:
			...
			operator ConstIterator<T>() const noexcept;
		...
		public:
			...
			operator ConstReverseIterator<T>() const noexcept;
...
template<typename T>
inline hgui::kernel::ConstIterator<T>::ConstIterator() noexcept :
	m_ptr(nullptr)
{
}

template<typename T>
inline hgui::kernel::ConstIterator<T>::ConstIterator(const T* ptr) noexcept :
	m_ptr(ptr)
{
}

template<typename T>
inline const typename hgui::kernel::ConstIterator<T>::reference hgui::kernel::ConstIterator<T>::operator*() const noexcept
{
	return *m_ptr;
}

template<typename T>
inline const typename hgui::kernel::ConstIterator<T>::pointer hgui::kernel::ConstIterator<T>::operator->() const noexcept
{
	return m_ptr;
}

template<typename T>
inline const typename hgui::kernel::ConstIterator<T>::reference hgui::kernel::ConstIterator<T>::operator[](const difference_type offset) const noexcept
{
	return *(m_ptr + offset);
}
...
template<typename T>
inline typename hgui::kernel::ConstIterator<T>& hgui::kernel::ConstIterator<T>::operator+=(const difference_type offset) noexcept
{
	m_ptr += offset;
	return *this;
}
...
template<typename T>
inline hgui::kernel::ConstReverseIterator<T>::ConstReverseIterator() noexcept :
	m_ptr(nullptr)
{
}

template<typename T>
inline hgui::kernel::ConstReverseIterator<T>::ConstReverseIterator(const T* ptr) noexcept :
	m_ptr(ptr)
{
}

template<typename T>
inline const typename hgui::kernel::ConstReverseIterator<T>::reference hgui::kernel::ConstReverseIterator<T>::operator*() const noexcept
{
	return *m_ptr;
}

template<typename T>
inline const typename hgui::kernel::ConstReverseIterator<T>::pointer hgui::kernel::ConstReverseIterator<T>::operator->() const noexcept
{
	return m_ptr;
}

template<typename T>
inline const typename hgui::kernel::ConstReverseIterator<T>::reference hgui::kernel::ConstReverseIterator<T>::operator[](const difference_type offset) const noexcept
{
	return *(m_ptr - offset);
}

template<typename T>
inline typename hgui::kernel::ConstReverseIterator<T>::ConstReverseIterator& hgui::kernel::ConstReverseIterator<T>::operator++() noexcept
{
	m_ptr--;
	return *this;
}
...
template<typename T>
inline typename hgui::kernel::ConstReverseIterator<T>::ConstReverseIterator hgui::kernel::ConstReverseIterator<T>::operator++(int) noexcept
{
...
template<typename T>
inline typename hgui::kernel::ConstReverseIterator<T>::ConstReverseIterator& hgui::kernel::ConstReverseIterator<T>::operator+=(const difference_type offset) noexcept
{
	m_ptr -= offset;
	return m_ptr;
}
...
template<typename T>
inline hgui::kernel::Iterator<T>::Iterator() noexcept :
	m_ptr(nullptr)
{
}

template<typename T>
inline hgui::kernel::Iterator<T>::Iterator(T* ptr) noexcept :
	m_ptr(ptr)
{
}
...
template<typename T>
inline typename hgui::kernel::Iterator<T>::reference hgui::kernel::Iterator<T>::operator[](const difference_type offset) const noexcept
{
	return *(m_ptr + offset);
}
...
template<typename T>
inline typename hgui::kernel::Iterator<T>::Iterator& hgui::kernel::Iterator<T>::operator+=(const difference_type offset) noexcept
{
	m_ptr += offset;
	return *this;
}
...
/*
template<typename T>
inline hgui::kernel::Iterator<T>::operator typename ConstIterator<T>() const noexcept
{
	return ConstIterator<T>(m_ptr);
}
*/
template<typename T>
inline hgui::kernel::ReverseIterator<T>::ReverseIterator() noexcept :
	m_ptr(nullptr)
{
}

template<typename T>
inline hgui::kernel::ReverseIterator<T>::ReverseIterator(T* ptr) noexcept :
	m_ptr(ptr)
{
}
...
template<typename T>
inline typename hgui::kernel::ReverseIterator<T>::reference hgui::kernel::ReverseIterator<T>::operator[](const difference_type offset) const noexcept
{
	return *(m_ptr - offset);
}
...
template<typename T>
inline typename hgui::kernel::ReverseIterator<T>::ReverseIterator& hgui::kernel::ReverseIterator<T>::operator+=(const difference_type offset) noexcept
{
	m_ptr -= offset;
	return *this;
}
...
/*
template<typename T>
inline hgui::kernel::ReverseIterator<T>::operator typename ConstReverseIterator<T>() const noexcept
{
	return ConstReverseIterator<T>(m_ptr);
}
*/